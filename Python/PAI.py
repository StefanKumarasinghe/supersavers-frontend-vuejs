...
Woolworths_URL = Data.Woolworths_URL
Coles_URL = Data.Coles_URL
CHEMIST_WAREHOUSE_URL = Data.CHEMIST_WAREHOUSE_URL
IGA_URL = Data.IGA_URL
...
async def search_products(query: str,code:str):
    ...
    iga_response = None
    woolworths_payload = Data.woolworths_payload
